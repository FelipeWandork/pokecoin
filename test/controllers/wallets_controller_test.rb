...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference("Wallet.count") do
      post wallets_url, params: { wallet: { dollar: @wallet.dollar, satoshi: @wallet.satoshi, user: @wallet.user } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { dollar: @wallet.dollar, satoshi: @wallet.satoshi, user: @wallet.user } }
